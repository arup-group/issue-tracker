...
{
    // This is a class to convert data between BCF 1.0 and 2.0 and has some BCF utilities
    public static class BcfAdapter
    {
        ...
        public static Tuple<List<BCF2.Markup>, int> GetBcfIssuesFromPath(string bcfFilePath)
        {
            List<BCF2.Markup> issues = new List<BCF2.Markup>();
            var dir = new DirectoryInfo(bcfFilePath);
            ...
            return new Tuple<List<BCF2.Markup>, int>(issues, errorCount);
        }
